<template>
  <div class="container-mypage-info">
    <h1>나의 정보</h1>
    <div class="div-decorate" style="margin-left:0px; margin-bottom: 10px; width: 10%"></div>
    <div class="div-mypage-info">
      <div class="div div-id">
        <label>아이디</label>
        <input class="input disabled" type="text" v-model="getCoach.coachId" disabled/>
      </div>
      <div class="div div-nickname">
        <label>닉네임</label>
        <input class="input" type="text" v-model="getCoach.coachNickname"/>
      </div>
      <div class="div div-name">
        <label>이름</label>
        <input class="input" type="text" v-model="getCoach.coachName"/>
      </div>
      <div class="div div-id">
        <label>생일</label>
        <input class="input" type="date" v-model="getCoach.coachBirth"/>
      </div>
      <div class="div div-id">
        <label>성별</label>
        <select ref="inputGender" v-model="getCoach.coachGender" required>
