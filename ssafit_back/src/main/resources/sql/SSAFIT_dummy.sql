...
insert into user (user_seq, user_id, user_password, user_name, user_email, user_birth, user_address, user_nickname, user_gender) values (0, 'jii', '1234', '김지현', 'jii@ssafy.com', '1997-03-03', '서울시 광진구', '젤레나', 'F'); 
insert into user (user_seq, user_id, user_password, user_name, user_email, user_birth, user_address, user_nickname, user_gender) values (0, 'sso', '1234', '김소정', 'sso@ssafy.com', '1997-06-06', '서울시 마포구', '블레어', 'F'); 
insert into user (user_seq, user_id, user_password, user_name, user_email, user_birth, user_address, user_nickname, user_gender) values (0, 'jay', '1234', '박재범', 'jay@ssafy.com', '1993-01-21', '서울시 강동구', '제이팍', 'M'); 
insert into user (user_seq, user_id, user_password, user_name, user_email, user_birth, user_address, user_nickname, user_gender) values (0, 'simon', '1234', '정기훈', 'simon@ssafy.com', '1984-09-09', '부산시 금정구', '쌈디', 'M'); 

select * from coach;
insert into coach (coach_seq, coach_id, coach_password, coach_name, coach_email, coach_birth, coach_address, coach_nickname, coach_gender) values (0, 'tubo', '1234', '김종국', 'tubo@ssafy.com', '1977-08-25', '서울시 동대문구', '꾹코치', 'M');
insert into coach (coach_seq, coach_id, coach_password, coach_name, coach_email, coach_birth, coach_address, coach_nickname, coach_gender) values (0, 'bbo', '1234', '정보경', 'bbo@ssafy.com', '1996-01-19', '서울시 관악구', '필라뽀스', 'F');
insert into coach (coach_seq, coach_id, coach_password, coach_name, coach_email, coach_birth, coach_address, coach_nickname, coach_gender) values (0, 'doctorK', '1234', '권한빛', 'doctorK@ssafy.com', '1974-12-25', '서울시 영등포구', '권선생', 'M');

select * from workout_super_type;
insert into workout_super_type (workout_super_class_seq, workout_super_class_type) values (1, '스트레칭');
insert into workout_super_type (workout_super_class_seq, workout_super_class_type) values (2, '근력강화');
insert into workout_super_type (workout_super_class_seq, workout_super_class_type) values (3, '체중감량');
insert into workout_super_type (workout_super_class_seq, workout_super_class_type) values (4, '체형교정');
insert into workout_super_type (workout_super_class_seq, workout_super_class_type) values (5, '요가');
insert into workout_super_type (workout_super_class_seq, workout_super_class_type) values (6, '골프');
insert into workout_super_type (workout_super_class_seq, workout_super_class_type) values (7, '테니스');

select * from workout_sub_type;
insert into workout_sub_type (workout_sub_class_seq, workout_sub_class_type) values (1, '전신');
insert into workout_sub_type (workout_sub_class_seq, workout_sub_class_type) values (2, '상체');
insert into workout_sub_type (workout_sub_class_seq, workout_sub_class_type) values (3, '하체');
insert into workout_sub_type (workout_sub_class_seq, workout_sub_class_type) values (4, '복부');

select * from coach_super_type;
insert into coach_super_type (coach_super_class_seq, coach_seq, workout_super_class_seq) values (0, 1, 2);
insert into coach_super_type (coach_super_class_seq, coach_seq, workout_super_class_seq) values (0, 1, 3);
insert into coach_super_type (coach_super_class_seq, coach_seq, workout_super_class_seq) values (0, 2, 3);
insert into coach_super_type (coach_super_class_seq, coach_seq, workout_super_class_seq) values (0, 2, 4);
insert into coach_super_type (coach_super_class_seq, coach_seq, workout_super_class_seq) values (0, 3, 1);
insert into coach_super_type (coach_super_class_seq, coach_seq, workout_super_class_seq) values (0, 3, 4);
...
insert into video_super_type (video_super_type_seq, video_seq, workout_super_class_seq) values (0, 1, 3);
insert into video_sub_type (video_sub_type_seq, video_seq, workout_sub_class_seq) values (0, 1, 3);
...
insert into video_super_type (video_super_type_seq, video_seq, workout_super_class_seq) values (0, 2, 3);
insert into video_sub_type (video_sub_type_seq, video_seq, workout_sub_class_seq) values (0, 2, 3);
...
insert into video_super_type (video_super_type_seq, video_seq, workout_super_class_seq) values (0, 3, 1);
insert into video_sub_type (video_sub_type_seq, video_seq, workout_sub_class_seq) values (0, 3, 2);
...
insert into video_super_type (video_super_type_seq, video_seq, workout_super_class_seq) values (0, 4, 1);
insert into video_sub_type (video_sub_type_seq, video_seq, workout_sub_class_seq) values (0, 4, 2);
...
insert into video_super_type (video_super_type_seq, video_seq, workout_super_class_seq) values (0, 5, 4);
insert into video_sub_type (video_sub_type_seq, video_seq, workout_sub_class_seq) values (0, 5, 2);
...
insert into video_super_type (video_super_type_seq, video_seq, workout_super_class_seq) values (0, 6, 3);
insert into video_sub_type (video_sub_type_seq, video_seq, workout_sub_class_seq) values (0, 6, 1);
...
insert into video_super_type (video_super_type_seq, video_seq, workout_super_class_seq) values (0, 7, 3);
insert into video_sub_type (video_sub_type_seq, video_seq, workout_sub_class_seq) values (0, 7, 1);
...
insert into video_super_type (video_super_type_seq, video_seq, workout_super_class_seq) values (0, 8, 2);
insert into video_sub_type (video_sub_type_seq, video_seq, workout_sub_class_seq) values (0, 8, 4);
